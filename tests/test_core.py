...
def test_patch_registry_add_patch(pytester: pytest.Pytester) -> None:
...
def test_patch_registry_add_patch_with_kwargs(pytester: pytest.Pytester) -> None:
...
def test_patch_registry_mixed(pytester: pytest.Pytester) -> None:
